...
import 'package:todoo/data/local/sqflite.dart';
import 'package:todoo/data/model/task_model.dart';
import 'package:todoo/domain/controller.dart';
import 'package:todoo/ui/layout/home_page.dart';
import 'package:todoo/ui/style/appColor.dart';
import 'package:todoo/ui/widget/Big_text.dart';
import 'package:todoo/ui/widget/Small_text.dart';
import 'package:todoo/ui/widget/defult_botton.dart';
import 'package:todoo/ui/widget/defult_field_text.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:todoo/ui/widget/snakbar.dart';
...
class _AddTaskPageState extends State<AddTaskPage> {
  ...
  Widget build(BuildContext context) {
    ...
    String hourLaterTime = DateFormat.jm().format(
      DateTime(2022, 1, 1, hourLater.hour, hourLater.minute),
    );
            ...
            children: [
                            ...
                            suffix: IconButton(
                              onPressed: () {
                                showDatePicker(
                                    ...
                                    .then((value) {
                                      controllers[2].text = DateFormat.yMd()
                                          .format(value!);
                                    })
                                    .catchError((e) {});
                              },
                                  ...
                                  suffix: IconButton(
                                    onPressed: () {
                                      showTimePicker(
                                        ...
                                        controllers[3].text = value!.format(
                                          context,
                                        );
                                      });
                                    },
                                  ...
                                  suffix: IconButton(
                                    onPressed: () {
                                      showTimePicker(
                                        ...
                                        controllers[4].text = value!.format(
                                          context,
                                        );
                                      });
                                    },
              ...
              Padding(
                ...
                child: DefultBotton(
                  ...
                  child: BigText("Creat", color: Colors.white),
                ),
              ),
            ],
          ),
